...
\vspace*{-7.8mm}
\section{EDUCATION}
{\customcventry{Expected Graduation: Fall 2021}{B.S. Computer Science,
...
{\begin{itemize}
  \item Increased test coverage using the Jest unit testing framework as well as Cypress E2E tests
...
{\begin{itemize}
  \item Python, Vue.js, C++, JavaScript, TypeScript, Java, SQL, PHP, Node
\end{itemize}
}
}
